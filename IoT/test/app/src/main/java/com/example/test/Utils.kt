...
//    list.add(Flight(currentMonth22.atTime(17, 40), Airport("Sokoto", "SKO"), Airport("Ilorin", "ILR"), R.color.red_800))
    ...
    val currentMonth22 = currentMonth.atDay(22)
    list.add(Flight(currentMonth22.atTime(13, 20), Airport("상의", "다른 정보"), Airport("하의", "다른 정보"), R.color.blue_800,
    ...
    list.add(Flight(currentMonth22.atTime(17, 40), Airport("상의", "다른 정보"), Airport("하의", "다른 정보"), R.color.red_800,
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfPPTMnXP6bGHP2nq1z-uQIjavz3xEXdgcbhrx0MYGVoRvD1EAXLsGA4GzZSgGcUoY4Dfop5bN&usqp=CAc"
    ))
    ...
    list.add(
        Flight(
            ...
            Airport("상의", "다른 정보"),
            Airport("하의", "다른 정보"),
            R.color.teal_700, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2EGgUT4iwXpFoOgEbwButFCBmlt6GWAV7NQ&usqp=CAU"
        )
    )
    ...
    list.add(
        Flight(
            ...
            Airport("상의", "다른 정보"),
            Airport("하의", "다른 정보"),
            R.color.orange_800, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrQXzIxSKQbyVI3ffqCQuYxJ4tg_85K8vgaeDGpcLLUTIZ_Ddu5ItLEjQ85juWnxWRTQQqEC5H&usqp=CAc"
        )
    )
